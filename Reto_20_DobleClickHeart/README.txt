...
-  El CSS está completo pero deben practicar y entender cómo funciona el keyframe grow para
la animación del corazón


JS

Revisar cómo funciona la creación de doble click a través de
...
una vez tengamos la coordenada dentro de la imagen podemos asignar el estilo con la posición dada
por las coordenadas
...
deben quitar los corazones después de que aparezcan.  (aunque no se ven en el front quedan cómo
código, validar por consola)